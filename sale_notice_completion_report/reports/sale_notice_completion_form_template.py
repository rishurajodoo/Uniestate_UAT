...
class SaleNoticeCompletionReport(models.AbstractModel):
    _name = 'report.sale_notice_completion_report.sale_notice_form'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        for line in docs.order_line:
            ...
            line_dict['price'] = line.price_subtotal
            line_list.append(line_dict)
        total_completion = sum(docs.plan_ids.filtered(lambda x: x.milestone_id.is_completion).mapped('amount'))
        total_payable = total_completion - sum(docs.mapped('paid_amount'))
